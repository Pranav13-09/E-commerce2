...
export const createOrder = (order) => async (dispatch) => {
  try {
    ...
    console.log("I have not placed order sucessfully");
    dispatch({
...
export const deleteOrder = (id) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.delete(`/order/admin/delete/orders/${id}`);
